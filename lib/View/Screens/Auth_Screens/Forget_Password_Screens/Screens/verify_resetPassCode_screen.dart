...
class VerifyResetPassCodeScreen extends StatelessWidget {
  VerifyResetPassCodeScreen({Key? key}) : super(key: key);
                    ...
                    child: VerificationCode(
                      ...
                      onCompleted: (String value) {
                        verificationController.verificationResetPassCode.value =
                            value;
                        if (kDebugMode) {
                          print(verificationController
                              .verificationResetPassCode.value);
                        }
                        verificationController.confirmCodeToResetPass(
