...
class AdoptionChatScreen extends StatefulWidget {
  const AdoptionChatScreen({Key? key}) : super(key: key);

  @override
  State<AdoptionChatScreen> createState() => _AdoptionChatScreenState();
}

class _AdoptionChatScreenState extends State<AdoptionChatScreen> {
