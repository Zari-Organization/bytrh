...
class CardGiftScreen extends StatelessWidget {
  CardGiftScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text("إهداء بطاقة لصديق"),
          centerTitle: true,
        ),
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Image.asset(
                  AppImages.gift_card_image,
                  fit: BoxFit.cover,
                  width: double.infinity,
                ),
                const SizedBox(height: 16),
                TitledTextField(
                  title: "أختر قيمة البطاقة التي تريدها",
                  // controller:
